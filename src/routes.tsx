...
interface RouterContext {
  ...
  handleEnrollProject: (projectId: string) => void;
        ...
        // Protected routes
        {
          ...
          element: context.currentUser ? (
            <DashboardPage
              ...
              onCreateProject={context.handleCreateProject}
              onDeleteProject={context.handleDeleteProject}
              onEnrollProject={context.handleEnrollProject}
        ...
        },
        {
          ...
          element: context.currentUser ? (
            <ProjectWorkspacePage
              currentUser={context.currentUser}
              projects={context.projects}
              onUpdateProject={context.handleUpdateProject}
            />
          ) : (
            <Navigate to="/login" replace />
          ),
